...
declare -a countryisolist=("UA" "FR" "ES" "SE" "DE" "FI" "NO" "PL" "IT" "GB" "RO" "BY" "GR" "BG" "IS" "PT" "CZ" "DK" "HU" "RS" "AT" "IE" "LT" "LV" "HR" "BA" "SK" "EE" "NL" "CH" "MD" "BE" "AL" "MK" "SI" "ME" "CY" "LU" "FO" "AD" "MT" "LI" "GG" "SM" "MC" "VA")
